...
res << zzz_vproto_internal_pack_caccounthardwarequeryaccountsregisteredtoserialaccounts(x, 1)
}
...
1 {
// [packed=false]
ii, v := zzz_vproto_internal_unpack_caccounthardwarequeryaccountsregisteredtoserialaccounts(cur_buf, tag_wiretype.wire_type)?
res.accounts << v
i = ii
}
...
res << zzz_vproto_internal_pack_caccounthardwaresteamcontrollersetconfigcontrollerconfig(x, 4)
}
...
4 {
// [packed=false]
ii, v := zzz_vproto_internal_unpack_caccounthardwaresteamcontrollersetconfigcontrollerconfig(cur_buf, tag_wiretype.wire_type)?
...
// [packed=false]
for _, x in o.configurations {
res << zzz_vproto_internal_pack_caccounthardwaresteamcontrollergetconfigcontrollerconfig(x, 1)
}
...
1 {
// [packed=false]
ii, v := zzz_vproto_internal_unpack_caccounthardwaresteamcontrollergetconfigcontrollerconfig(cur_buf, tag_wiretype.wire_type)?
res.configurations << v
i = ii
}
...
2 {
// [packed=false]
ii, v := zzz_vproto_internal_unpack_caccounthardwarevrcompatibilitycheckrequestpair(cur_buf, tag_wiretype.wire_type)?
res.values << v
i = ii
}
...
res << zzz_vproto_internal_pack_caccounthardwarevrcompatibilitycheckresponsecomponentdisplay(x, 2)
}
...
1 {
// [packed=false]
ii, v := zzz_vproto_internal_unpack_caccounthardwarevrcompatibilitycheckresponsepair(cur_buf, tag_wiretype.wire_type)?
res.values << v
i = ii
}
...
2 {
// [packed=false]
ii, v := zzz_vproto_internal_unpack_caccounthardwarevrcompatibilitycheckresponsecomponentdisplay(cur_buf, tag_wiretype.wire_type)?
res.components << v
i = ii
}
