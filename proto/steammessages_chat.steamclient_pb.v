...
ii, v := zzz_vproto_internal_unpack_cchatroomgroupheaderstate(cur_buf, tag_wiretype.wire_type)?
res.header_state = v
i = ii
}
...
ii, v := zzz_vproto_internal_unpack_echatroomnotificationlevel(cur_buf, tag_wiretype.wire_type)?
...
1 {
// [packed=false]
ii, v := zzz_vproto_internal_unpack_cchatroomgetmessagehistoryresponsechatmessage(cur_buf, tag_wiretype.wire_type)?
res.messages << v
i = ii
}
...
res << zzz_vproto_internal_pack_cchatroomgetchatroomgroupsummaryresponse(o.group_summary, 2)
}
...
ii, v := zzz_vproto_internal_unpack_cchatroomgetchatroomgroupsummaryresponse(cur_buf, tag_wiretype.wire_type)?
res.group_summary = v
i = ii
}
...
if o.has_group_summary {
res << zzz_vproto_internal_pack_cchatroomgetchatroomgroupsummaryresponse(o.group_summary, 8)
}
...
mut res := []byte{}
if o.has_group_summary {
res << zzz_vproto_internal_pack_cchatroomgetchatroomgroupsummaryresponse(o.group_summary, 1)
}
...
1 {
// [packed=false]
ii, v := zzz_vproto_internal_unpack_cchatroomgetinvitelinksforgroupresponselinkinfo(cur_buf, tag_wiretype.wire_type)?
res.invite_links << v
i = ii
}
...
1 {
// [packed=false]
ii, v := zzz_vproto_internal_unpack_cchatroomgetbanlistresponsebaninfo(cur_buf, tag_wiretype.wire_type)?
res.bans << v
i = ii
}
...
res << zzz_vproto_internal_pack_cchatroomsetuserchatgrouppreferencesrequestchatgrouppreferences(o.chat_group_preferences, 2)
}

// [packed=false]
for _, x in o.chat_room_preferences {
res << zzz_vproto_internal_pack_cchatroomsetuserchatgrouppreferencesrequestchatroompreferences(x, 3)
}
...
ii, v := zzz_vproto_internal_unpack_cchatroomsetuserchatgrouppreferencesrequestchatgrouppreferences(cur_buf, tag_wiretype.wire_type)?
...
3 {
// [packed=false]
ii, v := zzz_vproto_internal_unpack_cchatroomsetuserchatgrouppreferencesrequestchatroompreferences(cur_buf, tag_wiretype.wire_type)?
...
3 {
// [packed=false]
ii, v := zzz_vproto_internal_unpack_cchatroomdeletechatmessagesrequestmessage(cur_buf, tag_wiretype.wire_type)?
res.messages << v
i = ii
}
...
ii, v := zzz_vproto_internal_unpack_cmsgclientpersonastatefriend(cur_buf, tag_wiretype.wire_type)?
res.persona = v
i = ii
}
...
1 {
// [packed=false]
ii, v := zzz_vproto_internal_unpack_cchatroomsearchmembersresponsemembermatch(cur_buf, tag_wiretype.wire_type)?
...
res << zzz_vproto_internal_pack_cchatroomgetchatroomgroupsummaryresponse(o.chat_group_summary, 1)
}
...
3 {
// [packed=false]
ii, v := zzz_vproto_internal_unpack_cchatroomchatmessagemodifiednotificationchatmessage(cur_buf, tag_wiretype.wire_type)?
res.messages << v
i = ii
}
...
3 {
res.has_change = true
ii, v := zzz_vproto_internal_unpack_echatroommemberstatechange(cur_buf, tag_wiretype.wire_type)?
res.change = v
i = ii
}
...
if o.has_group_summary {
res << zzz_vproto_internal_pack_cchatroomgetchatroomgroupsummaryresponse(o.group_summary, 3)
}
...
// [packed=false]
for _, x in o.members {
res << zzz_vproto_internal_pack_cchatroomclientmemberlistviewupdatednotificationmemberlistviewentry(x, 4)
}
...
4 {
// [packed=false]
ii, v := zzz_vproto_internal_unpack_cchatroomclientmemberlistviewupdatednotificationmemberlistviewentry(cur_buf, tag_wiretype.wire_type)?
res.members << v
i = ii
}
...
ii, v := zzz_vproto_internal_unpack_cchatroommembersummarycounts(cur_buf, tag_wiretype.wire_type)?
...
res << zzz_vproto_internal_pack_cchatusabilityclientusabilitymetricsnotificationuistatecategorycollapsestate(o.category_collapse, 12)
}
...
ii, v := zzz_vproto_internal_unpack_cchatusabilityclientusabilitymetricsnotificationuistatecategorycollapsestate(cur_buf, tag_wiretype.wire_type)?
...
if o.has_settings {
res << zzz_vproto_internal_pack_cchatusabilityclientusabilitymetricsnotificationsettings(o.settings, 10)
}

if o.has_voice_settings {
res << zzz_vproto_internal_pack_cchatusabilityclientusabilitymetricsnotificationvoicesettings(o.voice_settings, 11)
}

if o.has_ui_state {
res << zzz_vproto_internal_pack_cchatusabilityclientusabilitymetricsnotificationuistate(o.ui_state, 12)
}

if o.has_metrics {
res << zzz_vproto_internal_pack_cchatusabilityclientusabilitymetricsnotificationmetrics(o.metrics, 13)
}
...
ii, v := zzz_vproto_internal_unpack_cchatusabilityclientusabilitymetricsnotificationsettings(cur_buf, tag_wiretype.wire_type)?
res.settings = v
i = ii
}
...
ii, v := zzz_vproto_internal_unpack_cchatusabilityclientusabilitymetricsnotificationvoicesettings(cur_buf, tag_wiretype.wire_type)?
...
ii, v := zzz_vproto_internal_unpack_cchatusabilityclientusabilitymetricsnotificationuistate(cur_buf, tag_wiretype.wire_type)?
res.ui_state = v
i = ii
}
...
ii, v := zzz_vproto_internal_unpack_cchatusabilityclientusabilitymetricsnotificationmetrics(cur_buf, tag_wiretype.wire_type)?
res.metrics = v
i = ii
}
