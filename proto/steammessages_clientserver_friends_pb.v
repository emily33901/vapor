...
2 {
// [packed=false]
ii, v := zzz_vproto_internal_unpack_cmsgclientfriendslistfriend(cur_buf, tag_wiretype.wire_type)?
res.friends << v
i = ii
}
...
3 {
// [packed=false]
ii, v := zzz_vproto_internal_unpack_cmsgclientfriendsgroupslistfriendgroup(cur_buf, tag_wiretype.wire_type)?
res.friendgroups << v
i = ii
}
...
4 {
// [packed=false]
ii, v := zzz_vproto_internal_unpack_cmsgclientfriendsgroupslistfriendgroupsmembership(cur_buf, tag_wiretype.wire_type)?
res.memberships << v
i = ii
}
...
3 {
// [packed=false]
ii, v := zzz_vproto_internal_unpack_cmsgclientplayernicknamelistplayernickname(cur_buf, tag_wiretype.wire_type)?
res.nicknames << v
i = ii
}
...
ii, v := zzz_vproto_internal_unpack_cmsgclientpersonastatefriendclandata(cur_buf, tag_wiretype.wire_type)?
res.clan_data = v
i = ii
}
...
71 {
// [packed=false]
ii, v := zzz_vproto_internal_unpack_cmsgclientpersonastatefriendkv(cur_buf, tag_wiretype.wire_type)?
res.rich_presence << v
i = ii
}
...
1 {
// [packed=false]
ii, v := zzz_vproto_internal_unpack_cmsgclientemoticonlistemoticon(cur_buf, tag_wiretype.wire_type)?
res.emoticons << v
i = ii
}
...
2 {
// [packed=false]
ii, v := zzz_vproto_internal_unpack_cmsgclientemoticonliststicker(cur_buf, tag_wiretype.wire_type)?
res.stickers << v
i = ii
}
...
3 {
// [packed=false]
ii, v := zzz_vproto_internal_unpack_cmsgclientemoticonlisteffect(cur_buf, tag_wiretype.wire_type)?
res.effects << v
i = ii
}
