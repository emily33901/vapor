...
6 {
// [packed=false]
ii, v := zzz_vproto_internal_unpack_ccloudbeginhttpuploadresponsehttpheaders(cur_buf, tag_wiretype.wire_type)?
...
5 {
// [packed=false]
ii, v := zzz_vproto_internal_unpack_clientcloudfileuploadblockdetailshttpheaders(cur_buf, tag_wiretype.wire_type)?
res.request_headers << v
i = ii
}
...
2 {
// [packed=false]
ii, v := zzz_vproto_internal_unpack_clientcloudfileuploadblockdetails(cur_buf, tag_wiretype.wire_type)?
...
10 {
// [packed=false]
ii, v := zzz_vproto_internal_unpack_ccloudclientfiledownloadresponsehttpheaders(cur_buf, tag_wiretype.wire_type)?
res.request_headers << v
i = ii
}
...
1 {
// [packed=false]
ii, v := zzz_vproto_internal_unpack_ccloudenumerateuserappsresponseapps(cur_buf, tag_wiretype.wire_type)?
res.apps << v
i = ii
}
