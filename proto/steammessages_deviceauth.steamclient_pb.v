...
1 {
// [packed=false]
ii, v := zzz_vproto_internal_unpack_cdeviceauthgetownauthorizeddevicesresponsedevice(cur_buf, tag_wiretype.wire_type)?
res.devices << v
i = ii
}
...
1 {
// [packed=false]
ii, v := zzz_vproto_internal_unpack_cdeviceauthgetusedauthorizeddevicesresponsedevice(cur_buf, tag_wiretype.wire_type)?
res.devices << v
i = ii
}
...
1 {
// [packed=false]
ii, v := zzz_vproto_internal_unpack_cdeviceauthgetauthorizedborrowersresponseborrower(cur_buf, tag_wiretype.wire_type)?
res.borrowers << v
i = ii
}
...
1 {
// [packed=false]
ii, v := zzz_vproto_internal_unpack_cdeviceauthgetauthorizedasborrowerresponselender(cur_buf, tag_wiretype.wire_type)?
res.lenders << v
i = ii
}
...
res << zzz_vproto_internal_pack_cdeviceauthgetexcludedgamesinlibraryresponseexcludedgame(x, 1)
}
...
1 {
// [packed=false]
ii, v := zzz_vproto_internal_unpack_cdeviceauthgetexcludedgamesinlibraryresponseexcludedgame(cur_buf, tag_wiretype.wire_type)?
...
2 {
// [packed=false]
ii, v := zzz_vproto_internal_unpack_cdeviceauthgetborrowerplayhistoryresponsegamehistory(cur_buf, tag_wiretype.wire_type)?
res.game_history << v
i = ii
}
...
res << zzz_vproto_internal_pack_cdeviceauthgetborrowerplayhistoryresponselenderhistory(x, 1)
}
...
1 {
// [packed=false]
ii, v := zzz_vproto_internal_unpack_cdeviceauthgetborrowerplayhistoryresponselenderhistory(cur_buf, tag_wiretype.wire_type)?
