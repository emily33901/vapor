...
1 {
// [packed=false]
ii, v := zzz_vproto_internal_unpack_cfriendmessagesgetrecentmessagesresponsefriendmessage(cur_buf, tag_wiretype.wire_type)?
res.messages << v
i = ii
}
...
res << zzz_vproto_internal_pack_cfriendsmessagesgetactivemessagesessionsresponsefriendmessagesession(x, 1)
}
...
1 {
// [packed=false]
ii, v := zzz_vproto_internal_unpack_cfriendsmessagesgetactivemessagesessionsresponsefriendmessagesession(cur_buf, tag_wiretype.wire_type)?
