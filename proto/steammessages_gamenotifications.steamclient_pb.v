...
2 {
// [packed=false]
ii, v := zzz_vproto_internal_unpack_cgamenotificationsvariable(cur_buf, tag_wiretype.wire_type)?
res.variables << v
i = ii
}
...
3 {
res.has_title = true
ii, v := zzz_vproto_internal_unpack_cgamenotificationslocalizedtext(cur_buf, tag_wiretype.wire_type)?
res.title = v
i = ii
}
...
4 {
// [packed=false]
ii, v := zzz_vproto_internal_unpack_cgamenotificationsuserstatus(cur_buf, tag_wiretype.wire_type)?
res.users << v
i = ii
}
...
1 {
// [packed=false]
ii, v := zzz_vproto_internal_unpack_cgamenotificationssession(cur_buf, tag_wiretype.wire_type)?
res.sessions << v
i = ii
}
...
// [packed=false]
for _, x in o.sessions {
res << zzz_vproto_internal_pack_cgamenotificationsgetsessiondetailsrequestrequestedsession(x, 1)
}
...
1 {
// [packed=false]
ii, v := zzz_vproto_internal_unpack_cgamenotificationsgetsessiondetailsrequestrequestedsession(cur_buf, tag_wiretype.wire_type)?
res.sessions << v
i = ii
}
...
1 {
// [packed=false]
ii, v := zzz_vproto_internal_unpack_gamenotificationsettings(cur_buf, tag_wiretype.wire_type)?
