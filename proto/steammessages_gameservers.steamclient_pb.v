...
1 {
// [packed=false]
ii, v := zzz_vproto_internal_unpack_cgameserversgetserverlistresponseserver(cur_buf, tag_wiretype.wire_type)?
res.servers << v
i = ii
}
...
1 {
// [packed=false]
ii, v := zzz_vproto_internal_unpack_cgameserversipswithsteamidsresponseserver(cur_buf, tag_wiretype.wire_type)?
res.servers << v
i = ii
}
