...
ii, v := zzz_vproto_internal_unpack_eremoteclientbroadcastmsg(cur_buf, tag_wiretype.wire_type)?
res.msg_type = v
i = ii
}
...
9 {
// [packed=false]
ii, v := zzz_vproto_internal_unpack_cmsgremoteclientbroadcaststatususer(cur_buf, tag_wiretype.wire_type)?
res.users << v
i = ii
}
...
if o.has_usage {
res << zzz_vproto_internal_pack_cmsgremotedeviceauthorizationrequestekeyescrowusage(o.usage, 5)
}
...
5 {
res.has_usage = true
ii, v := zzz_vproto_internal_unpack_cmsgremotedeviceauthorizationrequestekeyescrowusage(cur_buf, tag_wiretype.wire_type)?
res.usage = v
i = ii
}
...
mut total := 0
		for total < buf.len {
			...
			match tag_wiretype.tag {
1 {
ii, v := zzz_vproto_internal_unpack_eremotedeviceauthorizationresult(cur_buf, tag_wiretype.wire_type)?
res.result = v
i = ii
}
...
18 {
// [packed=false]
ii, v := zzz_vproto_internal_unpack_cmsgremotedevicestreamingrequestreservedgamepad(cur_buf, tag_wiretype.wire_type)?
res.gamepads << v
i = ii
}
...
2 {
ii, v := zzz_vproto_internal_unpack_eremotedevicestreamingresult(cur_buf, tag_wiretype.wire_type)?
res.result = v
i = ii
}
