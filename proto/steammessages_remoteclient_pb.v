...
3 {
res.has_status = true
ii, v := zzz_vproto_internal_unpack_cmsgremoteclientbroadcaststatus(cur_buf, tag_wiretype.wire_type)?
res.status = v
i = ii
}
...
ii, v := zzz_vproto_internal_unpack_cmsgremoteclientappstatusappupdateinfo(cur_buf, tag_wiretype.wire_type)?
res.update_info = v
i = ii
}
...
ii, v := zzz_vproto_internal_unpack_cmsgremoteclientappstatusshortcutinfo(cur_buf, tag_wiretype.wire_type)?
res.shortcut_info = v
i = ii
}
...
1 {
// [packed=false]
ii, v := zzz_vproto_internal_unpack_cmsgremoteclientappstatusappstatus(cur_buf, tag_wiretype.wire_type)?
...
9 {
// [packed=false]
ii, v := zzz_vproto_internal_unpack_cmsgremoteclientstartstreamreservedgamepad(cur_buf, tag_wiretype.wire_type)?
res.gamepads << v
i = ii
}
