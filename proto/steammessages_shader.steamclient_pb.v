...
4 {
// [packed=false]
ii, v := zzz_vproto_internal_unpack_cshaderregistershaderrequestshader(cur_buf, tag_wiretype.wire_type)?
res.shaders << v
i = ii
}
...
2 {
// [packed=false]
ii, v := zzz_vproto_internal_unpack_cshadersendshaderrequestshadercode(cur_buf, tag_wiretype.wire_type)?
res.shaders << v
i = ii
}
