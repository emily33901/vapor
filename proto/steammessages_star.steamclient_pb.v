...
ii, v := zzz_vproto_internal_unpack_cstarreadglyphdatarequest(cur_buf, tag_wiretype.wire_type)?
...
ii, v := zzz_vproto_internal_unpack_cstarwriteglyphdatarequest(cur_buf, tag_wiretype.wire_type)?
...
1 {
res.has_read_glyph_data = true
ii, v := zzz_vproto_internal_unpack_cstarreadglyphdataresponse(cur_buf, tag_wiretype.wire_type)?
res.read_glyph_data = v
i = ii
}
...
2 {
res.has_write_glyph_data = true
ii, v := zzz_vproto_internal_unpack_cstarwriteglyphdataresponse(cur_buf, tag_wiretype.wire_type)?
res.write_glyph_data = v
i = ii
}
