...
ii, v := zzz_vproto_internal_unpack_cmsgsteamdatagramsessioncryptinfoekeytype(cur_buf, tag_wiretype.wire_type)?
res.key_type = v
i = ii
}
...
5 {
// [packed=false]
ii, v := zzz_vproto_internal_unpack_esteamnetworkingsocketscipher(cur_buf, tag_wiretype.wire_type)?
res.ciphers << v
i = ii
}
...
ii, v := zzz_vproto_internal_unpack_cmsgsteamdatagramlinkinstantaneousstats(cur_buf, tag_wiretype.wire_type)?
res.instantaneous = v
i = ii
}
...
ii, v := zzz_vproto_internal_unpack_cmsgsteamdatagramlinklifetimestats(cur_buf, tag_wiretype.wire_type)?
res.lifetime = v
i = ii
}
...
ii, v := zzz_vproto_internal_unpack_cmsgicerendezvouscandidate(cur_buf, tag_wiretype.wire_type)?
res.add_candidate = v
i = ii
}
...
res << zzz_vproto_internal_pack_cmsgsteamnetworkingp2prendezvousconnectrequest(o.connect_request, 4)
}
...
res << zzz_vproto_internal_pack_cmsgsteamnetworkingp2prendezvousconnectionclosed(o.connection_closed, 6)
}
...
ii, v := zzz_vproto_internal_unpack_cmsgsteamnetworkingp2prendezvousconnectrequest(cur_buf, tag_wiretype.wire_type)?
...
ii, v := zzz_vproto_internal_unpack_cmsgsteamnetworkingp2prendezvousconnectok(cur_buf, tag_wiretype.wire_type)?
res.connect_ok = v
i = ii
}
...
ii, v := zzz_vproto_internal_unpack_cmsgsteamnetworkingp2prendezvousconnectionclosed(cur_buf, tag_wiretype.wire_type)?
...
13 {
// [packed=false]
ii, v := zzz_vproto_internal_unpack_cmsgsteamnetworkingp2prendezvousreliablemessage(cur_buf, tag_wiretype.wire_type)?
