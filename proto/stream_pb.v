...
mut total := 0
		for total < buf.len {
			...
			match tag_wiretype.tag {
1 {
ii, v := zzz_vproto_internal_unpack_cstreamingclienthandshakeinfo(cur_buf, tag_wiretype.wire_type)?
res.info = v
i = ii
}
...
mut total := 0
		for total < buf.len {
			...
			match tag_wiretype.tag {
1 {
ii, v := zzz_vproto_internal_unpack_cstreamingserverhandshakeinfo(cur_buf, tag_wiretype.wire_type)?
res.info = v
i = ii
}
...
1 {
res.has_result = true
ii, v := zzz_vproto_internal_unpack_cauthenticationresponsemsgauthenticationresult(cur_buf, tag_wiretype.wire_type)?
res.result = v
i = ii
}
...
ii, v := zzz_vproto_internal_unpack_estreamqualitypreference(cur_buf, tag_wiretype.wire_type)?
res.quality = v
i = ii
}
...
ii, v := zzz_vproto_internal_unpack_estreamhostplayaudiopreference(cur_buf, tag_wiretype.wire_type)?
...
2 {
ii, v := zzz_vproto_internal_unpack_estreammousewheeldirection(cur_buf, tag_wiretype.wire_type)?
res.direction = v
i = ii
}
...
3 {
// [packed=false]
ii, v := zzz_vproto_internal_unpack_cframestataccumulatedvalue(cur_buf, tag_wiretype.wire_type)?
...
1 {
res.has_webrtc = true
ii, v := zzz_vproto_internal_unpack_ctransportsignalmsgwebrtcmessage(cur_buf, tag_wiretype.wire_type)?
res.webrtc = v
i = ii
}
